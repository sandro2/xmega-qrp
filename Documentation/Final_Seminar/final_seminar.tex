...
\begin{itemize}
\item \textbf{Aim} - Design and build a low power HF data transmitter for use in remote sensor systems.
...
\item Multiple power amplifier options
\end{itemize}
}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=3.0cm]{images/horus_launch.jpg}
  \end{center}
\end{figure}
